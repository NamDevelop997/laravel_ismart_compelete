            ...
            <section class="products m-5">
                ...
                <div class="row mt-5">
                    ...
                    <div class="card col-4  border-0 product w3-animate-left">
                        <img class="card-img-top" src="" alt="afd">
                        <div class="card-body text-center">
                            <h4 class="card-title font-weight-bold">1232</h4>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-6 text-center p-0">
                                        <img src="{{ asset('public/uploads/posts/samsung-apple-crop-1634095615035.jpeg') }}"
                                            alt="" width="80%" height="100">
                                    </div>
                                    <div class="col-6 text-left p-0">
                                        <a href="">(Dân trí) - Tại thị trường Việt Nam, iPad Mini 6 </a>
                                        <p>Ma văn nam - 29.10.2021</p>
                                    </div>
                                </div>
                            </li>
